...
- (UIColor*)overlayColor {
    if (!_overlayColor) {
        _overlayColor = [UIColor blueColor];
    }
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    image = [image filteredImageUsingContrastFilter];
    ...
    if (self.isBorderDetectionEnabled) {
        ...
        if (_borderDetectLastRectangleFeature) {
            ...
            // Draw Center
            if(self.enableDrawCenter) image = [image drawCenterOverlayWithColor:[UIColor blueColor] point:_borderDetectLastRectangleFeature.centroid];
